package com.taskapp.notification.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, TaskDTO> consumerFactory() {
        ...
        return new DefaultKafkaConsumerFactory<>(props, new StringDeserializer(), new ErrorHandlingDeserializer<>(new JsonDeserializer<>(TaskDTO.class, false)));
    }
